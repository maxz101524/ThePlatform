...
**Population:** Weekly sync computes top 200 per (sex, equipment, weight_class) from full OPL CSV. ~2 sexes x 4 equipment x ~12 weight classes x 200 = ~19,200 rows, with overlap ~25K.
